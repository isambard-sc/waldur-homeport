    ...
    () =>
      [
        ...
        },
        {
          ...
          description: isSelf
            ? translate('A short, unique name for you. It will be used to form your local username on any systems. Should only contain lower-case letters and digits and must start with a letter. Must be between 5-20 characters long.')
            : translate('A short, unique name for the user. It will be used to form their local username on any systems. Should only contain lower-case letters and digits and must start with a letter. Must be between 5-20 characters long.'),
          requiredMsg: props.isRequired('unix_username')
            ? getDefaultRequiredMsg(translate('UNIX user name'), isSelf)
            : null,
          protected: props.fieldIsProtected('unix_username'),
